...
export interface AppReadStream {
  stream: Readable;
  type?: string;
  length?: number;
}

export interface AppZipStream extends AppReadStream {
...
export class StorageRepository {
  ...
  async createReadStream(filepath: string, mimeType?: string | null): Promise<AppReadStream> {
